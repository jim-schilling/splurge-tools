...
class RandomHelper:
    ...
    @classmethod
    def as_int_range(cls, lower: int, upper: int, *, secure: Optional[bool] = False) -> int:
    ...
    @classmethod
    def as_string(cls, length: int, allowable_chars: str, *, secure: Optional[bool] = False) -> str:
        ...
        return ''.join([allowable_chars[cls.as_int_range(0, len(allowable_chars) - 1, secure=secure)] for _ in range(0, length)])


    @classmethod
    def as_variable_string(cls, lower: int, upper: int, allowable_chars: str, *, secure: Optional[bool] = False) -> str:
    ...
    @classmethod
    def as_variable_base58(cls, lower: int, upper: int, *, secure: Optional[bool] = False) -> str:
    ...
    @classmethod
    def as_variable_alpha(cls, lower: int, upper: int, *, secure: Optional[bool] = False) -> str:
    ...
    @classmethod
    def as_variable_alphanumeric(cls, lower: int, upper: int, *, secure: Optional[bool] = False) -> str:
        ...
        Example:
            ...
            'Xy4'
        """
        return cls.as_variable_string(lower, upper, cls.ALPHANUMERIC_CHARS, secure=secure)


    @classmethod
    def as_variable_numeric(cls, lower: int, upper: int, *, secure: Optional[bool] = False) -> str:
    ...
    def as_sequenced_string(
        ...
        *, 
        ...
        if start + count > max_value:
            raise ValueError(f'digits not large enough to hold sequence value of {max_value}')

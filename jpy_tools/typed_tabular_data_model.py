...
class TypedTabularDataModel(TabularDataModel):
    ...
    def row(self, index: int) -> dict[str, Any]:
        ...
        return {self._column_names[i]: self._typed_data[index][i] for i in range(self._columns)}
    ...
    def column_type(self, name: str) -> DataType:
        ...
        if name not in self._column_types:
            ...
            non_empty_values = [v for v in values if not String.is_empty_like(v) and not String.is_none_like(v)]
            if non_empty_values:

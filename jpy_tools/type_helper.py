...
class String:
    ...
    def is_float_like(value: Union[str, float, None], trim: bool = True) -> bool:
        ...
        return re.match(r"""^[-+]?(\d+)?\.(\d+)?$""", value.strip() if trim else value) is not None
    ...
    @classmethod
    def is_datetime_like(cls, value: Union[str, datetime, None], trim: bool = True) -> bool:
        """
    ...
    @classmethod
    def to_bool(cls, value: Union[str, bool, None], default: Union[bool, None] = None, trim: bool = True) -> Union[bool, None]:
        """
    ...
    @classmethod
    def to_float(cls, value: Union[str, float, None], default: Union[float, None] = None, trim: bool = True) -> Union[float, None]:
        """
    ...
    @classmethod
    def to_int(cls, value: Union[str, int, None], default: Union[int, None] = None, trim: bool = True) -> Union[int, None]:
        """
    ...
    @classmethod
    def to_date(cls, value: Union[str, date, None], default: Union[date, None] = None, trim: bool = True) -> Union[date, None]:
        """
    ...
    @classmethod
    def to_datetime(cls, value: Union[str, datetime, None], default: Union[datetime, None] = None, trim: bool = True) -> Union[datetime, None]:
        """
    ...
    @classmethod
    def infer_type(cls, value: Union[str, bool, int, float, date, datetime, None], trim: bool = True) -> DataType:
        """
    ...
    @classmethod
    def infer_type_name(cls, value: Union[str, bool, int, float, date, datetime, None], trim: bool = True) -> str:
        """
...
def is_list_like(value: Any) -> bool:
    ...
    if hasattr(value, '__iter__') and hasattr(value, 'append') and hasattr(value, 'remove') and hasattr(value, 'index'):
        return True
...
def is_iterable(value: Any) -> bool:
    ...
    if hasattr(value, '__iter__') and hasattr(value, '__getitem__') and hasattr(value, '__len__') and hasattr(value, '__next__'):
        return True

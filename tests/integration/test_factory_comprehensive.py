...
from splurge_tools.protocols import StreamingTabularDataProtocol, TabularDataProtocol
...
class TestModelConstruction(unittest.TestCase):
    ...
    def _assert_is_tabular_data_protocol(self, obj):
        ...
        assert isinstance(obj, TabularDataProtocol | StreamingTabularDataProtocol), (
    ...
    def test_explicit_construction_only(self):
        ...
        assert isinstance(m3, StreamingTabularDataProtocol)
        m4 = create_in_memory_model([["name"], ["x"]])
        assert isinstance(m4, TabularDataProtocol)
...
class TestComponentFactoryComprehensive(unittest.TestCase):
    ...
    def test_create_transformer(self):
        ...
        # Test basic functionality
        assert transformer.can_transform(self.data_model)
